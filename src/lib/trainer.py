...
class Trainer:
    ...
    └── {{dataset.name}}/
        ...
        │       ├── metrics_filename  # filename to keep metrics generated and elapsed times
        │       ├── {{model.name}}
        │       │   └── ... # model weights/parameters, trainings artifacts (e.g callbacks), etc ...
    ...
    def run(self, experiment, model, dataset, training, tracking):
        ...
        self.logger.info("Tracking information will be savec in the following directory: {}".format(
        ...
        trainings_dataset_execution_model_path = os.path.join(trainings_dataset_execution_path, model.name)
        os.makedirs(trainings_dataset_execution_model_path)

        # Measure time and temporary change directory in case model wants to save some artifact while fitting
        with elapsed_time() as elapsed, chdir(trainings_dataset_execution_model_path):
        ...
        metrics_path = os.path.join(trainings_dataset_execution_path, self.metrics_filename)
