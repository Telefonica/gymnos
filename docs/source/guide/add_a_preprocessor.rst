...
The preprocessor registration process is done by associating the preprocessor id with their path:
...
2. Register preprocessor in your module ``__init__.py`` referencing the type and the path:
